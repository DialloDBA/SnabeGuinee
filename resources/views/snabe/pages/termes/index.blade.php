        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="condition-content pr-20">
                    ...
                    <h4>Terms & Conditions Consent</h4>
                    ...
                    <div class="list">
                        <ul>
                            <li><i class="ri-checkbox-line"></i>Lorem ipsum dolor sit amet, adipiscing elit, sed do
                                eiusmod tempor commodo viverra</li>
                            <li><i class="ri-checkbox-line"></i>It is a long established fact that a reader will be
                                distracted</li>
                            <li><i class="ri-checkbox-line"></i>Contrary to popular belief, Lorem Ipsum is not
                                simply random text.</li>
                        </ul>
                    </div>
                    ...
                    <div class="related-post-area">
                        ...
                        <div class="related-post-box">
                            <div class="related-post-content">
                                ...
                                <h4><a href="latest-news.html">Making a meaningful difference in patients’
                                        lives.</a></h4>
                                <p><i class="flaticon-tag"></i> Social Sciences</p>
                            </div>
                        </div>
