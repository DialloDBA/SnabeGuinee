        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="latest-news-left-content pr-20">
                    <div class="latest-news-simple-card" style="background-image: url('{{ asset("asset/images/news/news-5.jpg")}}') !important;">
                        <div class="news-content">
                            <div class="list">
                                <ul>
                                    <li><i class="flaticon-user"></i>Par <a href="news-details.html"> administrateur</a></li>
                            ...
                            <a href="news-details.html" class="read-more-btn active">En savoir plus
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-news-card">
                                    ...
                                    <div class="news-content">
                                        ...
                                        <a href="{{route('news.post',[$a->category,$a->unique])}}" class="read-more-btn text-prim">Lire Plus...<i class="flaticon-next"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="category-list">
                    ...
                    <ul>
                        @foreach ($cats as $c)
                        <li>
                            <a href="{{route('news.category',$c)}}">{{$c->libelle_cat}} (<span>{{ $c->posts()->where('actived','1')->count()}}</span>)<i class="ri-arrow-drop-right-fill"></i></a>
                        </li>
                        @endforeach
                    </ul>
                </div>
                <div class="related-post-area">
                    <h3 class="text-prim">Articles similaires</h3>
