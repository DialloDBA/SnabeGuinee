							...
							<table class="table table-striped custom-table datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{$u->telephone_1 ?? 'Non defini'}}</td>
										<td>{{$u->telephone_2 ?? 'Non defini'}}</td>
										<td>{{$u->adresse ?? 'Non defini'}}</td>
										<td>{{$u->fonction ?? 'Non defini'}}</td>
										<td>{{(new DateTime($u->created_at))->format("d-m-Y H:i")}}</td>
										<td>
...
<script src="{{asset('assets/actions/users.js')}}"></script>
@endsection