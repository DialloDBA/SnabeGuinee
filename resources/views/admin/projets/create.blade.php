            ...
            <div class="col-md-12 col-lg- offset-l-2">
                    <form action="{{ route("admin.projets.store")}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Titre du Projet" name="titre_projet" value="{{old('titre_projet') ?? '' }}"/>
                                    @error('titre_projet')
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" min="0" max="10" placeholder="Titre du Projet" name="priorite_projet" value="{{old('priorite_projet') ?? '' }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="" cols="30" rows="3" class="form-control" placeholder="Resumé du Projet" name="resume_projet">{{old('resume_projet') ?? '' }}</textarea>
                            @error('resume_projet')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea id="contenu" cols="30" rows="15" class="form-control" placeholder="Contenu du Projet" name="contenu_projet">{{old('contenu_projet') ?? '' }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="1" class="form-control" placeholder="Les Mots Clés du Projet" name="motcles_projet">{{old('motcles_projet') ?? '' }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="1" class="form-control" placeholder="Les meta données du Projet" name="metadata_projet">{{old('metadata_projet') ?? '' }}</textarea>
