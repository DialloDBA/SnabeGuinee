...
<div class="content container-fluid">
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-12 ">
                    <form class="create-temoignage" action="{{ route("admin.temoignages.update",$t)}}" method="POST" enctype="multipart/form-data">
                        @csrf 
                        @method("PUT")
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Prénom du Témoin..." name="prenom_temoin" value="{{old('prenom_temoin') ?? $t->prenom_temoin}}"/>
                                    @error('prenom_temoin')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Nom du Témoin..." name="nom_temoin" value="{{old('nom_temoin') ?? $t->nom_temoin}}"/>
                                    @error('nom_temoin')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Profession du Témoin..." name="profession_temoin" value="{{old('profession_temoin') ?? $t->profession_temoin}}"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <input type="tel" name="telephone_temoin" id="telephone_temoin" class="form-control" value="{{ old('telephone_temoin') ?? $t->telephone_temoin }}" placeholder="Telephone du Témoin">
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="5" class="form-control message_temoin" id="message_temoin" placeholder="Message du Témoin..." name="message_temoin">{!! old('message_temoin') ?? $t->message_temoin !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                value="0"
                                @if ($t->actived=='0') checked="" @endif
                                />
                                <label class="form-check-label" for="statut_temoignage_inactive"> Inactif</label>
                            </div>
                        </div>
                        <div class="submit-section">
                            <button class="btn btn-primary btn-create">Modifier ce Témoignage</button>
                        </div>
                    </form>
                </div>
            </div>
