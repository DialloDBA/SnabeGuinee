...
@section('content')
    ...
    <div class="tiny-slider-one-wrapper">
        <div class="tiny-slider-one">
            <!-- Single Hero Slide -->
            <div>
            <div class="single-hero-slide bg-overlay" style="background-image: url('{{asset('ui/img/bg-img/31.jpg')}}')">
            ...
            <!-- Single Hero Slide -->
            <div>
            <div class="single-hero-slide bg-overlay" style="background-image: url('{{asset('ui/img/bg-img/33.jpg')}}')">
                <div class="h-100 d-flex align-items-center text-center">
                <div class="container">
            ...
            <!-- Single Hero Slide -->
            <div>
            <div class="single-hero-slide bg-overlay" style="background-image: url('{{asset('ui/img/bg-img/32.jpg')}}')">
                <div class="h-100 d-flex align-items-center text-center">
                <div class="container">
        ...
        <div class="card mb-3">
            ...
            <div class="row g-3">
                ...
                <div class="feature-card mx-auto text-center">
                    <div class="card mx-auto bg-gray">
                    <img src="{{asset('auth/img/demo-img/dark.png')}}" alt="">
                    </div>
                    <p class="mb-0">Mode Nuit</p>
                </div>
                </div>
