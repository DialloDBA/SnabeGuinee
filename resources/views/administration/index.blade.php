...
<div class="content container-fluid">
    ...
    <div class="row staff-grid-row">
        ...
        <div class="profile-widget">
            ...
            <a href="chat.html" class="btn btn-white btn-sm m-t-10"
            >Message</a
            >
            <a
            href="client-profile.html"
            class="btn btn-white btn-sm m-t-10"
            >View Profile</a
            >
        </div>
        </div>
        ...
        <div class="profile-widget">
            <div class="profile-img">
            <a href="client-profile.html" class="avatar"
                ><img alt="" src="assets/img/profiles/avatar-29.jpg"
            /></a>
            </div>
            <div class="dropdown profile-action">
            <a
        ...
        <div class="profile-widget">
            <div class="profile-img">
            <a href="client-profile.html" class="avatar"
                ><img alt="" src="assets/img/profiles/avatar-18.jpg"
            /></a>
            </div>
            <div class="dropdown profile-action">
            <a
        ...
        <div class="profile-widget">
            <div class="profile-img">
            <a href="client-profile.html" class="avatar"
                ><img alt="" src="assets/img/profiles/avatar-28.jpg"
            /></a>
            </div>
            <div class="dropdown profile-action">
            <a
