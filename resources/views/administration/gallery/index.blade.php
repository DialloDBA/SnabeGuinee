          ...
          <div class="row align-items-center">
                <div class="col">
                  ...
                  <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Liste des Images de la Gallerie</li>
                  </ul>
                </div>
                <div class="col-auto float-right ml-auto">
                    <a href="{{ route("admin.gallery.create")}}" class="btn add-btn">
                        <i class="fa fa-plus-circle"></i> {{ __("Ajouter une/des Image(s)")}}
                    </a>
                </div>
          </div>
        </div>
