            ...
            <div class="col-md-12 col-lg- offset-l-2">
                    <form action="{{ route("admin.articles.store")}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Titre de l'article" name="titre_de_larticle" value="{{old('titre_de_larticle') ?? ''}}"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="categorie_de_larticle" class="select floating" id="categorie">
                                        <option value="" selected>Choisir la Categorie</option>
                                        @foreach ($categories as $c)
                                        <option value="{{$c->id}}" >{{$c->libelle_categorie}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor" cols="30" rows="3" class="form-control summernote" placeholder="Resumé de l'article" name="resume_de_larticle">{{old('resume_de_larticle') ?? ''}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="contenu" cols="30" rows="15" class="form-control summernote" placeholder="Contenu de l'article" name="contenu_de_larticle">{{old('contenu_de_larticle') ?? ''}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="1" class="form-control summernote" placeholder="Les Mots Clés de l'article" name="motcles_de_larticle">{{old('motcles_de_larticle') ?? ''}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="30" rows="1" class="form-control summernote" placeholder="Les meta données de l'article" name="metadata_de_larticle">{{old('metadata_de_larticle') ?? ''}}</textarea>
                        ...
                        <div class="submit-section">
                            <button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Créer cet article</button>
                        </div>
                    </form>
            </div>
      </div>
