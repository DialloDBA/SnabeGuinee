...
<div class="content">
    <div data-select2-id="26">
          ...
          <div class="row align-items-center">
                <div class="col">
                  ...
                  <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edition du Groupe d'Image {{$groupeImage->libelle}}</li>
                  </ul>
                </div>
        ...
        <form action="{{route('admin.groupeimages.update',$groupeImage)}}" method="post">
        @csrf
        @method('PUT')
        <div class="row filter-row mb-5">
            <div class="col-sm-6 col-md-3">
                <div class="form-group form-focus">
                    <input type="text" class="form-control floating" value="{{old('libelle_groupe') ?? $groupeImage->libelle }}" name="libelle_groupe">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="form-group form-focus select-focus">
                    <select class="select floating" name="statut_groupe">
                        ...
                        <option value="1" @if ($groupeImage->statut=='1') selected @endif>Actif</option>
                        <option value="0" @if ($groupeImage->statut=='0') selected @endif>Inactif</option>
                    </select>
            ...
            <div class="col-sm-6 col-md-3">
                <button type="submit" class="btn btn-success btn-block"><i class="fa fa-pencil"></i> Mettre à Jour </a>
            </div>
        </div>
    </form>
        <div class="row">
