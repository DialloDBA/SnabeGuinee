(function ($) {
        ...
        .on("submit", function (event) {
            ...
            $.ajax({
                ...
                beforeSend:function(){
                    ...
                    $(".newsletter-form").find('.default-btn').html('Abonnement en cours...').addClass('disabled');
                    
                    $(".custom-alert").find('p').text('');
                    $(".custom-alert").find('h4').text('');

                },
                success : function(data){
                    $(".newsletter-form").find('.default-btn').html("S'abonner").addClass('disabled');
                    if(data.success==true){
                        $(".newsletter-form")[0].reset();
                        $(".custom-alert").find('p').text(data.message);
                        $(".custom-alert").find('h4').text(data.type);
                        $(".custom-alert").fadeIn(500).delay(5000).fadeOut(700);
                    }
                },
    ...
    $("body").append("<a href='/' class='buy-now-btn' style='background:transparent !important;'><img class='h-100 w-100' src='" + branding + "' alt='National Branding'/></a>");
